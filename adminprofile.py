...
for i in t:
    print(
        """<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td> %s </td> <td> %s </td><td><a href =" pdelete.py?id=%d">delete</a></td><td> <a href="pedit.py?id=%d">edit</a></td></tr>""" %(i[0],i[1],i[2],i[3],i[4],i[5],i[0],i[0]))
print("""
</table>
</form>                 
</body>
...
for j in s:
        print(
            """<b><tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td> %s </td> <td> %s </td><td> %s </td><td> %s </td><td>%s</td><td><a href ="adelete.py?id=%d">delete</a></td><td> <a href="edit.py?id=%d">Accept Appointment</a></td></tr><b>""" %(j[0],j[1],j[2],j[3],j[4],j[5],j[6],j[7],j[8],j[0],j[0]))
print("""
</table>
</div>
</body> 
